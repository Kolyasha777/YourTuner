package com.example.tuner.components
...
import com.example.tuner.ui.theme.Yellow500
   ...
   // onTuned: () -> Unit
    ...
    Row(
        ...
        TuningMeter(
            ...
            TuningMeterLabel(noteOffset = offset, color = color,
...
private fun TuningMeterLabel(
    noteOffset: Double?,
    displayType: TuningDisplayType = TuningDisplayType.SEMITONES,
    color: Color
) {
...
private fun YellowPreview() {
    PreviewWrapper {
        TuningDisplay(noteOffset = remember { mutableStateOf(2.07) })
    }
}
...
private fun RedPreview() {
    PreviewWrapper {
        TuningDisplay(noteOffset = remember { mutableStateOf(-27.0) })
    }
}
